...
<div class="w-[{{ $size }}] h-[{{ $size }}] rounded-[20px] bg-[#7A798A] relative"><img src="" alt="" class="w-full object-cover object-center">
    <div class="w-[{{ $check }}] h-[{{ $check }}] rounded-full flex items-center justify-center absolute bottom-0 right-0 bg-[#5142FC]">
